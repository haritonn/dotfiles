...
-- Telescope
map("n", "<leader>ff", function() require('telescope.builtin').find_files() end, { desc = "Файлы" })
map("n", "<leader>fr", function() require('telescope.builtin').oldfiles() end, { desc = "Недавние" })
map("n", "<leader>fb", function() require('telescope.builtin').buffers() end, { desc = "Буферы" })
